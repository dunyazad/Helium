...
//	float frameDistanceDistance0 = FLT_MAX;
//	int frameDistanceFrame0 = 0;
//	vec2 frameDistanceFrameUV0;

//	float frameDistanceDistance1 = FLT_MAX;
//	int frameDistanceFrame1 = 0;
//	vec2 frameDistanceFrameUV1;
...
//				if(frameDistance < frameDistanceDistance0) {
//					frameDistanceDistance1 = frameDistanceDistance0;
//					frameDistanceFrame1 = frameDistanceFrame0;
//					frameDistanceFrameUV1 = frameDistanceFrameUV0;

//					frameDistanceDistance0 = frameDistance;
//					frameDistanceFrame0 = i;
//					frameDistanceFrameUV0 = uv;
//				} else if(frameDistance < frameDistanceDistance1) {
//					frameDistanceDistance1 = frameDistance;
//					frameDistanceFrame1 = i;
//					frameDistanceFrameUV1 = uv;
//				}
...
//				vec3 pointToFrame = normalize(GetFramePosition(i) - GetWorldPosition());
//				if(dot(pointToFrame, frameDirection) < 0) {
//					vec4 colorUVCenterFrame = texture(textureArray, vec3(uv.x, uv.y, i));
//					float ratioUV = clamp(1 - pow(abs(sin(PI * (uvDistance / uvDistanceMax) / 2.0)), 3.0), 0, 1);
//					accumulatedColorUV = mix(accumulatedColorUV, colorUVCenterFrame, ratioUV);
//				}
//			}
...
//	vec4 fdt = texture(textureArray, vec3(frameDistanceFrameUV0.x, frameDistanceFrameUV0.y, frameDistanceFrame0));

//	if(frameDistanceFrame0 == 9)
//	{
//		//float colorTempK = mix(1000.0, 40000.0, controlValue);

//		vec3 colorTempRGB = ColorTemperatureToRGB(6500 * (controlValue + 0.5));

//		float originalLuminance = Luminance(fdt.rgb);

//		vec3 blended = mix(fdt.rgb, fdt.rgb * colorTempRGB, 0.5);
